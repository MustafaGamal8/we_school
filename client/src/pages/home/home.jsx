...
<button onClick={handelGoTop} className="bg-main text-white font-semibold py-2 px-4 rounded-full w-[35px] fixed bottom-7 right-7 z-10" id="btn"><AiOutlineArrowUp/></button>
